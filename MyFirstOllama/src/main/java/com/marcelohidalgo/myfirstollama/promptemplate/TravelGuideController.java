...
public class TravelGuideController {
    ...
    public TravelGuideController(OllamaService service) {
    ...
    public String getChatResponse(@RequestParam("city") String city, @RequestParam("month") String month, @RequestParam("language") String language, @RequestParam("budget") String budget, Model model) {
